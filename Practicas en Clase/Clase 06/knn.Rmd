...
```{r}
glass <- read_csv("datos/glass.data",col_names=c("Id", "RI", "Na", "Mg", "Al", "Si", "K", "Ca", "Ba", "Fe", "Type"))
...
Al final no nos interesa saber cuales son las variables mas correlacionadas, porque ambas nos dicen lo mismo entonces no son con las que queremos trabajar realmente. Al final lo que queremos son las ortogonales porque nos van a explicar mejor su conjunto.
