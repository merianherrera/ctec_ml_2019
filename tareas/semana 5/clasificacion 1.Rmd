...
```{r}
modelo_arbol <- rpart(class ~ ., data = mushroom_entrenamiento[,-which(colnames(mushroom_entrenamiento) == "cap_shape")], method =  'class')
...
paste("* Precisión del modelo Arbol de decision: ", precision_arbol)
