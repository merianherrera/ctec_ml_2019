...
```{r}
pred.int <- predict(linear_model, data=autos_testing, interval = "prediction")

autos_predicted <- cbind(autos_training, pred.int)
# 2. Regression line + confidence intervals
p <- ggplot(autos_predicted, aes(mpg, hp)) +
  geom_point() +
...
#?predict
#linear_model$terms
#typeof(regresion_data_training)
# mse(preds = NULL, actuals = NULL, weights = 1, na.rm = FALSE)
#?mse
# mse(linear_model, mpg_predict)
```
