...
# Reemplazar los valores en "0" dentro de la columna caballos de fuerza.
hp_mode <- get.mode(autos$hp)
autos$hp[autos$hp == 0] <- hp_mode
...
hist(log10(autos$mpg), col="#cfbae1",border="#c59fc9")
hist(log10(autos$hp), col="#cfbae1",border="#c59fc9")
hist(log10(autos$disp), col="#cfbae1",border="#c59fc9")
```
