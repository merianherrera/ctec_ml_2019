...
autos$dividir_datos <- sample.split(y, SplitRatio=0.75)
head(autos, 400)
```
...
```{r}
regresion_data_training = lessR::reg(mpg ~ disp + weight, 
           data=autos_training, dframe=autos_training, 
           sig.digits=4, res.rows=NULL)
...
regresion_testing = lessR::reg(mpg ~ disp + weight, 
